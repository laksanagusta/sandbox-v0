      ...
      <div className="bg-background min-h-screen">
        <div className="w-full mx-auto px-8 py-8">
          <div className="text-center">
            <Building className="mx-auto h-16 w-16 text-muted-foreground/50 mb-4" />
            <h2 className="text-lg font-medium text-foreground mb-2">Organization tidak ditemukan</h2>
            <p className="text-muted-foreground mb-4">Organization yang Anda cari tidak ditemukan atau telah dihapus</p>
